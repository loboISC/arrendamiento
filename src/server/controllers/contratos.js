...
exports.getById = async (req, res) => {
  try {
    ...
    // Obtener información de logística (opcional, no bloquea la carga del contrato)
    ...
    try {
      ...
      console.warn(`[getById] No se pudo cargar logística para contrato ${id}:`, logErr.message);
    }
