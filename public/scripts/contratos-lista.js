...
function mostrarModalEdicion(contrato) {
    ...
    if (form) {
        ...
        const enviarHPNotaEdicion = () => {
            ...
            const iframe = document.querySelector('iframe[src*="/templates/pdf/hoja_pedido2.html"]');
...
async function abrirVistaPreviaPDFEdicion(idContrato) {
    ...
    window.open('/templates/pdf/pdf_contrato.html', '_blank');
}
...
function abrirVistaPreviaNotaEdicion(idContrato) {
    ...
    window.open('/templates/pdf/hoja_pedido2.html', '_blank');
}
