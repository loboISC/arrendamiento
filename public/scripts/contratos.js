...
document.addEventListener('keydown', function (e) {
    ...
    */
    ...
    if (window.electronAPI && typeof window.electronAPI.readFile === 'function') {
        window.electronAPI.readFile('templates/pdf_templates/pdf_contrato.html')
            .then(html => {
    ...
    if (window.electronAPI && typeof window.electronAPI.readFile === 'function') {
        window.electronAPI.readFile('templates/pdf_templates/hoja_pedido2.html')
            .then(html => {
                noteTemplate = html;
    ...
    if (window.electronAPI && typeof window.electronAPI.readFileDataUrl === 'function') {
        window.electronAPI.readFileDataUrl('assets/images/logo-demo.jpg')
            .then(dataUrl => {
                logoDataUrl = dataUrl;
